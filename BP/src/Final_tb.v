...
`elsif lv1cach
	`ifdef SDF
		...
		`include "./syn/lv1cach_syn.v"
	`else
		`include "./ALUPipeline_BP/RISCV_pipeline.v"
		`include "./BPscheme/1_level_cache.v"
	`endif
`elsif lv2glo
	`ifdef SDF
		`define SDFFILE "./syn/lv2glo_syn.sdf"
		`include "./syn/lv2glo_syn.v"
	`else
		`include "./ALUPipeline_BP/RISCV_pipeline.v"
